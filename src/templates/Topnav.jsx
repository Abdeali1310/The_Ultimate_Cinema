...
import Sidenav from "../templates/Sidenav"; // Ensure this is imported correctly
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="navbar z-50 top-5 absolute w-full  left-14 xl:left-56 flex items-center gap-5 text-zinc-300">
        ...
        <input
          type="search"
          className="px-5 outline-none border-none bg-transparent text-xl w-full max-w-[70vh] h-[4.5vh] rounded-lg"
          name="search"
          id="search"
